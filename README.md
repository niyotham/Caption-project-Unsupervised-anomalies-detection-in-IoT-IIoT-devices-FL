...
This repository contains the code for the the project submitted for the requiremt to graduate in masters of science in computing at The American University in Cairo.
...
Comparison of testing results of the ML and Vanilla FL(FedAvg)  
